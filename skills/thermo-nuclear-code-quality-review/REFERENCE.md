...
## 4. Tests and future testability
...
* type guard used as feature-flag discriminant — `!Array.isArray(null)` is true, so uninitialized slice silently picks wrong path
...
Prefer split by responsibility: orchestration, domain decision, adapter/I/O, rendering, policy/rules, fixtures/builders.

## 8. Parallel / atomic work
